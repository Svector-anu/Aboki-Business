    ...
    <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 pb-20">
      <div className="mb-4 sm:mb-6">
        ...
        <p className="text-xs sm:text-sm text-gray-600 mt-1">
          Buy crypto with Nigerian Naira
        </p>
      </div>
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <button
                  ...
                  className={`flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all ${paymentMethod === 'bank'
                      ? 'border-purple-600 bg-purple-50'
                      : 'border-gray-200 hover:border-gray-300'
                    }`}
                >
                ...
                <button
                  ...
                  className={`flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all ${paymentMethod === 'more'
                      ? 'border-purple-600 bg-purple-50'
                      : 'border-gray-200 hover:border-gray-300'
                    }`}
                >
