...
export default function HomePage() {
   ...
   const LoadingComponent = ({ message, showPulse = false }) => (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-600 via-purple-700 to-blue-800 relative overflow-hidden">
         ...
         <div className="text-center text-white z-10 relative">
            ...
            <p className="text-sm text-white/70">
               {showPulse ? "Taking you to your destination..." : "Please wait while we prepare everything..."}
            </p>

            {/* Progress bar */}
            <div className="mt-8 w-64 mx-auto">
               <div className="w-full bg-white/20 rounded-full h-1 overflow-hidden">
                  <div className={`h-full bg-gradient-to-r from-white to-blue-200 ${showPulse ? 'w-full animate-pulse' : 'w-1/3 animate-pulse'} transition-all duration-1000`}></div>
               </div>
            </div>
   ...
   if (loading) {
      return (
         <>
            ...
            <LoadingComponent message="Loading your workspace" />
         </>
      );
   }
   ...
   return (
      <>
         ...
         <LoadingComponent message="Redirecting" showPulse={true} />
      </>
   );
}